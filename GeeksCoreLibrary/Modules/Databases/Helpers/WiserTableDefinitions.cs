...
public class WiserTableDefinitions
{
    ...
    [
        ...
        new()
        {
            ...
            LastUpdate = new DateTime(2025, 6, 24),
            Columns =
            [
                new ColumnSettingsModel("id", MySqlDbType.Int32, notNull: true, isPrimaryKey: true, autoIncrement: true),
                new ColumnSettingsModel("module_id", MySqlDbType.Int32, notNull: true, defaultValue: "0"),
        ...
        new()
        {
            ...
            LastUpdate = new DateTime(2025, 8, 21),
            Columns =
            [
                new ColumnSettingsModel("id", MySqlDbType.Int32, notNull: true, isPrimaryKey: true, autoIncrement: true),
        ...
        new()
        {
            ...
            [
                ...
                new ColumnSettingsModel("linked_object_table_name", MySqlDbType.VarChar, 64, notNull: true, defaultValue: "", comment: "The table name of the linked object, that should contain the linked_object_id value."),
