    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new ColumnSettingsModel("request_headers", MySqlDbType.Text, 0),
                new ColumnSettingsModel("request_query_string", MySqlDbType.Text, 0),
                new ColumnSettingsModel("request_form_values", MySqlDbType.MediumText, 0),
                new ColumnSettingsModel("request_body", MySqlDbType.MediumText, 0),
                new ColumnSettingsModel("response_body", MySqlDbType.MediumText, 0),
                new ColumnSettingsModel("error", MySqlDbType.Text, 0),
                new ColumnSettingsModel("url", MySqlDbType.Text, 0),
