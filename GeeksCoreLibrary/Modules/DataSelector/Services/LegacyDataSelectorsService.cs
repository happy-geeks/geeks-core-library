...
{
    public class LegacyDataSelectorsService : IDataSelectorsService
    {
        ...
        private readonly ILogger<LegacyDataSelectorsService> logger;
        private readonly ILanguagesService languagesService;

        public LegacyDataSelectorsService(IOptions<GclSettings> gclSettings, IDatabaseConnection databaseConnection, IStringReplacementsService stringReplacementsService, ITemplatesService templatesService, IHtmlToPdfConverterService htmlToPdfConverterService, IExcelService excelService, ILogger<LegacyDataSelectorsService> logger, ILanguagesService languagesService)
        {
        ...
        private void ReplaceVariableValuesInDataSelector(Models.DataSelector selector)
        {
        ...
        private void ReplaceVariableValuesInConnections(IEnumerable<Connection> connections)
        {
        ...
        private void ReplaceVariableValuesInScopes(IEnumerable<Scope> scopes)
        {
            if (scopes == null)
            {
                return;
