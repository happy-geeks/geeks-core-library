...
public class ObjectsService : IObjectsService, IScopedService
{
    ...
    /// </summary>
    public ObjectsService(IDatabaseConnection databaseConnection, IOptions<GclSettings> gclSettings, IReplacementsMediator replacementsMediator, IHttpContextAccessor httpContextAccessor = null)
    {
