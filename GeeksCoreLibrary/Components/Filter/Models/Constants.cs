...
public static class Constants
{
    ...
    internal const string TemplateFull = """
                                         <section>
                                         	    <div class="container">
                                                     <div class="row">
                                                         <div class="col col--1">
    ...
    internal const string TemplateFilterGroup = """
                                                <div class="filter-widget multi-filter">
    ...
    internal const string TemplateSlider = """
                                           <div class="filter-widget price-filter" data-name="{filtergroup}" data-min="{minValue}" data-max="{maxValue}" data-currentmin="{selectedMin}" data-currentmax="{selectedMax}">
    ...
    internal const string TemplateSummary = """
    ...
    internal const string TemplateSummaryFilterGroup = """
                                                       <div class="filter-results">
                                                               <!-- <a href="{url}">Wis alle</a> -->
                                                               {selectedvalues:Raw}
                                                           </div>
    ...
    internal const string TemplateSummaryFilterGroupItem = """
                                                           <a href="{url}" class="filter-result">
                                                                   <span>{name}</span>
                                                                   <svg class="icon">
