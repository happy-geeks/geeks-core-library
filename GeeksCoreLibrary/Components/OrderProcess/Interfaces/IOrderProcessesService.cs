...
namespace GeeksCoreLibrary.Components.OrderProcess.Interfaces
{
    ...
    public interface IOrderProcessesService
    {
        ...
        Task<OrderProcessSettingsModel> GetOrderProcessViaFixedUrl(string fixedUrl);
        ...
        Task<List<OrderProcessStepModel>> GetAllStepsGroupsAndFields(ulong orderProcessId);
    }
}
