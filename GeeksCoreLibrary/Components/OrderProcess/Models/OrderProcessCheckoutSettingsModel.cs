...
internal class OrderProcessCheckoutSettingsModel
{
    ...
    [DefaultValue("""
                  <div class='order-container'>{progress}</div>
                  <div class='order-container'>{step}</div>
                  """)]
    internal string Template { get; }

    [DefaultValue("""
                  <form method='POST' id='step{activeStep}' data-active-step='{activeStep}' class='step-container'>
    ...
    [DefaultValue("""
                  <div id='container_{fieldId}' class='field {errorClass} {fieldClass}'>
    ...
    [DefaultValue("""
                  <div id='container_{fieldId}' class='field multi-line {errorClass} {fieldClass}'>
    ...
    [DefaultValue("""
                  <div id='container_{fieldId}' class='field full {errorClass} {fieldClass}'>
    ...
    [DefaultValue("""
                  <div class='progress-step {active}' id='progressStep{number}' data-active-step='{activeStep}' data-id='{id}'>
