...
public static class Constants
{
    ...
    internal const string DefaultLoginMainQuery = """
                                                  SELECT account.title
                                                  FROM wiser_item AS account
                                                  WHERE account.id = ?userId
                                                  """;

    internal const string DefaultLoginQuery = """
                                              SELECT
                                                  account.id,
    ...
    internal const string DefaultSaveLoginQuery = """
    ...
    internal const string DefaultLoginSuccessTemplate = """
    ...
    internal const string DefaultLoginErrorTemplate = """
                                                      <div class='error'>
    ...
    internal const string DefaultSaveResetPasswordValuesQuery = """
                                                                INSERT INTO wiser_itemdetail (item_id, `key`, `value`)
    ...
    internal const string DefaultValidateResetPasswordTokenQuery = """
                                                                   SELECT login.value AS login
                                                                   FROM wiser_item AS account
    ...
    internal const string DefaultChangePasswordQuery = """
                                                       INSERT INTO wiser_itemdetail (item_id, `key`, `value`)
    ...
    internal const string DefaultGetUserIdViaEmailAddressQuery = """
