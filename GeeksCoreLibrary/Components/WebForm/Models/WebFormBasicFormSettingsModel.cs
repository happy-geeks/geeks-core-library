...
{
    [DefaultValue("""
                  <!-- There must always be an element with ID GclWebFormContainer{contentId}, all fields within are sent to the server via ajax, unless you also overwrite the TemplateJavascript. -->
