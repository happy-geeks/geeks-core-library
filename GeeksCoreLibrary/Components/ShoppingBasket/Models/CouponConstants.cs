...
{
    /// <summary>
    /// Constants for the various detail keys that are used for coupons.
    /// </summary>
    public static class CouponConstants
    {
        ...
        public const string UsedCountKey = "usedcount";
        public const string DiscountOnlyOnProductsKey = "discountonlyonproducts";
        public const string MinPurchasePriceKey = "minpurchaseprice";
        public const string FreePaymentServiceProviderCostsKey = "freepaymentserviceprovidercosts";
