...
namespace GeeksCoreLibrary.Components.Configurator.Models
{
    public class ConfiguratorCmsSettingsModel : CmsSettings
    {
        ...
        #endregion
        #region Tab Obsolete properties
        /// <summary>
        ///  The HTML that is generated by this component.
        /// </summary>
        [CmsProperty(PrettyName = "HTML",
                     Description = "The HTML that is generated by this component.",
                     DeveloperRemarks = "Any value entered here will be ignored.",
                     TabName = CmsAttributes.CmsTabName.Obsolete,
                     GroupName = CmsAttributes.CmsGroupName.Obsolete,
                     TextEditorType = CmsAttributes.CmsTextEditorType.HtmlEditor,
                     DisplayOrder = 5
        )]
