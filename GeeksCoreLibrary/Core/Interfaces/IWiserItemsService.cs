...
namespace GeeksCoreLibrary.Core.Interfaces
{
    public interface IWiserItemsService
    {
        ...
        Task<WiserItemModel> UpdateAsync(ulong itemId, WiserItemModel wiserItem, ulong userId = 0, string username = "GCL", string encryptionKey = "", bool alwaysSaveValues = false, bool saveHistory = true, bool createNewTransaction = true, EntitySettingsModel entityTypeSettings = null);
        ...
        /// <param name="permissions">Optional: If you already have the permissions for this item, add them here. Otherwise leave empty, then they will be retrieved from the database. This parameter is mostly meant to be used in CachedItemsService.</param>
        ...
        Task<(bool ok, string errorMessage, AccessRights permissions)> CheckIfEntityActionIsPossibleAsync(ulong itemId, EntityActions action, ulong userId, WiserItemModel wiserItem = null, bool onlyCheckAccessRights = false, string entityType = null, AccessRights? permissions = null);
